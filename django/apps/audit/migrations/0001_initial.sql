-- THESAURUS AUDIT
-- taken from https://github.com/2ndQuadrant/audit-trigger
-- done changes:
-- -- removed client_addr/client_port (since thesaurus use docker network)
-- -- removed application_name
-- -- instead of direct use of session_user_name use query to temp table _user_tmp created by middleware
-- THESAURUS END OF CUSTOM changes
